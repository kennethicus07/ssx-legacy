            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>The following companies have had their <strong>Statement of Account (SOA)</strong> generated for fair code <strong>{{ $event_name }}</strong>:</p>
                        ...
                        <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
                            ...
                            <tbody>
                                @foreach($attendances as $attendance)
                                    <tr>
                                        <td>{{ $attendance->exhibitor->co_name ?? 'N/A' }}</td>
                                        <td>{{ $attendance->user->email ?? 'N/A' }}</td>
                                        <td>{{ $attendance->soa_at->format('Y-m-d H:i') ?? 'N/A' }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
