            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>Your <strong>Statement of Account (SOA)</strong> for the event <strong>{{ $event_name }}</strong> has been sent successfully.</p>

                        <p>Kindly review your SOA document at your earliest convenience to confirm your registration and payment details.</p>

                        {{-- <p style="text-align: center;">
                            <a href="{{ url('/supplier/soa') }}" style="background-color:#1a73e8;color:white;padding:10px 20px;text-decoration:none;border-radius:5px;">Review SOA</a>
                        </p> --}}
                ...
                <td style="background: #f8f8f8;">
                    <div style="padding: 10px;">
                        ...
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 11px; text-align: center;">
                            ...
                            <strong>Email:</strong> <a href="mailto:{{ env('SSX_EMAIL') }}" target="_blank">{{ env('SSX_EMAIL') }}</a>
                        </p>
                    </div>
                </td>
            </tr>
            <tr>
                <td style="background: #9daa39;">
                    <table cellspacing="0" cellspacing="0" width="100%">
                        <tr>
                            <td><a href="{{ env('APP_URL') }}"><img src="{{ url('https://sustainability.ph/assets/images/ssx-full-logo-white.png') }}?v=2026_v1" width="120"></a></td>
                            <td>
                                <p style="font-family: Arial, Helvetica, sans-serif; color: #fff; text-align: right; margin-bottom: 0; font-size: 12px; padding-right: 15px;">Follow Us</p>
