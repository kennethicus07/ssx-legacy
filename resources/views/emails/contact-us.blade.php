            ...
            <tr>
                <td>
                    <div
                        ...
                        <!--CONTENT HERE -->
                        <p>Hi OG2,</p>
                        <p>{{ ucwords($info['fullname']) }} sent a message using the inquiry form in SSX website.</p>
                            ...
                            <center>
                                <table cellpadding="5" cellspacing="0" border="1" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 20px; border: #ccc 1px; width: 80%;">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"><p>{{ $info['email'] }}</p></td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><p><strong>Full Name:</strong></p></td>
                                        <td width="75%"><p>{{ ucwords($info['fullname']) }}</p></td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><p><strong>Company or Organization:</strong></p></td>
                                        <td width="75%"><p>{{ ucwords($info['company']) }}</p></td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><p><strong>Message:</strong></p></td>
                                        <td width="75%"><p>{{ ucwords($info['message']) }}</p></td>
                                    </tr>
                                </table>
                            </center>
                        </p>
