                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"
                        ...
                        <tr>
                            ...
                            <td align="right" valign="middle" style="padding:12px 15px;">
                                <img src="{{ url('https://sustainability.ph/assets/images/2026_oct_buyers.png') }}" alt="Event Info" width="180"
                ...
                <td>
                    <div
                        ...
                        @if ($group == 'Supplier')
                            ...
                            <p>After thorough evaluation, we cannot qualify your application due to insufficient
                                information or non-compliance to some documentary requirements. </p>
                            <p>For clarification on the result of your registration, we look forward to hearing from you
                                via​ <a href="mailto:{{ env('SSX_EMAIL') }}" target="_blank">{{ env('SSX_EMAIL') }}</a>.
                            </p>
                            <p>Thank you.</p>
                        @else
                            <p>We regret that your application as Purchaser is insufficient to merit its approval.</p>
                            <p>If you have questions regarding your registration, feel free to contact our team via <a
