            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>Good news! The following supplier/exhibitor has <strong>approved</strong> the conforme for
                            the
                            event <strong>{{ $event_name }}</strong>:</p>
                        ...
                        <p>You may proceed with the next steps required for this supplier/exhibitor.</p>
