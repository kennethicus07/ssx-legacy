                        ...
                        <tr>
                            ...
                            <td align="left" valign="middle" style="padding:12px 15px;">
                                <a href="{{ env('APP_URL') }}" style="display:block;">
                                    <img src="{{ url('https://sustainability.ph/assets/images/ssx-full-logo-white.png') }}?v=2026" alt="SSX Logo"
                                        width="160"
            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>
                            A new application has been approved in the Sustainability Solutions Exchange (SSX) system.
                            Kindly review the details below for your approval and processing.
                        </p>
                    ...
                    <table cellspacing="0" cellspacing="0" width="100%">
                        <tr>
                            <td><a href="{{ env('APP_URL') }}"><img
                                        src="{{ url('https://sustainability.ph/assets/images/ssx-full-logo-white.png') }}?v=2026" width="120"></a>
                            </td>
                            <td>
                                <p
