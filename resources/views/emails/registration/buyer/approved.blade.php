                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"
                        ...
                        <tr>
                            ...
                            <td align="right" valign="middle" style="padding:12px 15px;">
                                <img 
                                 src="{{ url('https://sustainability.ph/assets/images/2026_oct_buyers.png') }}"
                               alt="Event Info" width="180"
            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>Congratulations! You are now officially registered as a Purchaser/Buyer for the
                            {{ $event_name }}!</p>
                        <p>
                            Please stay tuned for upcoming announcements and exclusive updates for the event taking
                            place on
                            {{ $event_dates }}, in {{ $location }}.
                        </p>
                            ...
                            <td>
                                ...
                                <p style="text-align: right; margin-top: 0;">
                                    <a href="{{ env('APP_SOCIAL_FACEBOOK') }}" target="_blank">
                                        <img src="{{ url('https://sustainability.ph/assets/images/facebook-icon.png') }}"
