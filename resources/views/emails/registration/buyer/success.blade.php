            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>Thank you for submitting your application as a Purchaser/Buyer for {{ $event_name }}</p>

                        <p>You are receiving this email to confirm your completed registration.
                        </p>

                        <p>
                            Please give us time to review your application.<br />
                            You will receive confirmation within 72 hours for the approval of your
                            application.
                        </p>

                        <p>We look forward to welcoming you to {{ $event_name }}! </p>
