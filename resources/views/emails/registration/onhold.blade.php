            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>Hi {{ $fname }},</p>
                        @if ($group == 'Supplier')
                            <p>Sorry, your application as Supplier is put on waitlist status due to incomplete
                                submission of some documentary requirements.</p>
                            <p>Our SSX supplier team will send you a direct email via <a
                                    href="mailto:{{ env('SSX_EMAIL') }}" target="_blank">{{ env('SSX_EMAIL') }}</a> for
                                the next steps.</p>
                            <p>Thank you and we look forward to your successful registration in the Sustainability
                                Solutions Exchange.</p>
                            <p>Warmest,</p>
                        @else
                            <p>Thank you for your application but it is put on hold until the necessary information and
                                requirements are satisfied. </p>
                            <p>Please expect communication from our Project Officer for clarification/verification of
                                your application.</p>
                            <p>If you have questions regarding your application, feel free to contact our team via <a
                                    href="mailto:{{ env('SSX_EMAIL') }}" target="_blank">{{ env('SSX_EMAIL') }}</a>.</p>
                            <p>Thank you and please continue your support to Sustainability Solutions Exchange.</p>
                        @endif
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
