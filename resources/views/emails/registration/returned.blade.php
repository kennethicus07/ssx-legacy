            ...
            <tr>
                <td>
                    <div
                        ...
                        <p>Your registration for <strong>{{ $event_name }}</strong> has been returned.
                            Please continue your registration to complete the process.</p>
                        <p style="text-align: center; margin: 20px 0;"><a href="{{ $reg_link }}" target="_blank"
                                style="background: #9daa39; 
          color: #fff; 
