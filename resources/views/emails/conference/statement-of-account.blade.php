    ...
    <table cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
            <td style="padding:40px;font-size:14px;line-height:24px;color:#333333;">
                ...
                <p>
                    Please find attached the <strong>Statement of Account</strong>
                    for the delegate(s) you registered for the
                    <strong>{{ $eventName }}</strong>.
                </p>

                <p>
                    The registered delegate(s) will receive a separate email
                    confirming their registration for the conference.
                </p>

                <p>
                    Thank you, and we look forward to welcoming you to the
                    <strong>SSX Conference 2026</strong>.
                </p>
