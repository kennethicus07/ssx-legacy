...
@section('content')
    ...
    {{-- Hero Section --}}
<section class="sdg-hero-section">
    <picture>
        <source
            media="(max-width: 700px)"
            srcset="{{ asset('assets/sdg_asia_2026/mobile_sdg_2026.png') }}"
        >

        <img
            src="{{ asset('assets/sdg_asia_2026/desktop_sdg_2026.png') }}"
            alt="SDG Asia 2026"
            class="sdg-hero-image"
        >
    </picture>
</section>
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('assets/sdg_asia_2026/sidelines-photo.png') }}" alt="SDG Asia Mission"
                        class="img-fluid rounded-4 sdg-sidelines-img">
                </div>
            </div>
        </div>
    </section>
