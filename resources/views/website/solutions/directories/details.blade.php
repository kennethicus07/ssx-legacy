            ...
            <ul class="nav nav-pills nav-fill">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="products-tab" data-bs-toggle="tab" data-bs-target="#products"
                        type="button" role="tab" aria-controls="products" aria-selected="true">Products and
                        Services</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="about-tab" data-bs-toggle="tab" data-bs-target="#about" type="button"
                            ...
                            <div class="solutions-holder">
                                @foreach ($user->products as $product)
                                    <div class="solution product">
                                        <div class="image">
                                            <a
                                                href="{{ route('solutions.directories.product_details', [$exhibitor->slug, $product->id, $product->slug]) }}"><img
                                                    src="{{ check_file_exist('exhibitors/products/thumbs/', 'thumb', $product->product_image[0]->image) }}"
                                                    class="d-block w-100" alt="..."></a>
                                        </div>
                                        <div class="desc">
                                            <h6><a href="#">{{ $exhibitor->co_name }}</a></h6>
                                            <h3><a
                                                    href="{{ route('solutions.directories.product_details', [$exhibitor->slug, $product->id, $product->slug]) }}">{{ $product->name }}</a>
                                            </h3>
                                            <p>
                                                {{ Str::limit($product->description, 60) }} <a
                                                    href="{{ route('solutions.directories.product_details', [$exhibitor->slug, $product->id, $product->slug]) }}">Learn
                                                    more</a>
                                            </p>
                                        </div>
                                    </div>
