    ...
    <div id="heroCarousel" class="carousel slide carousel-fade hero-carousel" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ check_file_exist('articles/banners/', 'masthead', $article->image_banner) }}" class="d-block w-100" alt="...">
            </div>
        </div>
    </div>
    ...
    <div class="section ssx-info beige-bg resource-holder">
        <div class="content black">
            ...
            <div class="cards-wrapper four">
                ...
                <div class="card black">
                    <div class="img-wrapper">
                        <img src="{{ check_file_exist('articles/thumbs/', 'thumb', $latest_article->image_thumb) }}" class="d-block w-100" alt="..."> 
                    </div>
                    <div class="card-body">
                        <h5 class="card-title"><a href="{{ route('solutions.intelligence.details', [$latest_article->slug]) }}" class="text-decoration-none">{{ $latest_article->title }}</a></h5>
                        <p class="card-text simple-lnk">
                            {{ \Illuminate\Support\Str::limit($latest_article->sub_title, 100) }} 
                            <a href="{{ route('solutions.intelligence.details', [$latest_article->slug]) }}" class="arrow_btn">Learn More</a>
                        </p>
            ...
            <p class="align-right simple-lnk">
                <a href="{{ route('solutions.intelligence.index') }}" class="arrow_btn">Read all articles</a>
            </p>
        </div>
    </div>
