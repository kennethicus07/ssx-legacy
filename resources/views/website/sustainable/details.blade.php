                ...
                <div class="card black">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text simple-lnk">
                            ...
                            <a href="{{ route('news-articles.details', [$latest_article->slug]) }}" class="arrow_btn">Learn More</a>
                        </p>
                        @if (!empty($latest_article->category_tag))
                        <p class="tags">
                            @foreach ($latest_article->category_tag as $tag)
                            <span class="badge rounded-pill lightgreen-bg">{{ $tag->sub_category->name }}</span>
                            @endforeach
                        </p>
                        @endif
                    </div>
