...
<div class="container-fluid">
    <form method="POST" action="{{ route('admin.export-enablers.programs-offers.update', [$article->id]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <h5 class="card-header">Updating program & offer</h5>
                    <div class="card-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="select2 form-select shadow-none" name="enabler" id="enabler">
                                ...
                                <option value="{{ $enabler->id }}" {{ ($article->enabler_id == $enabler->id) ? 'selected' : '' }}>{{ $enabler->co_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mt-3">
