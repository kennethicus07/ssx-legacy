                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Update Solutions Intelligence Article
                        </li>
                    </ol>
                </nav>
            </div>
...
<div class="container-fluid">
    <form method="POST" action="{{ route('admin.articles.solutions-intelligence.update', [$article->id]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <h5 class="card-header">Updating solutions intelligence article</h5>
                    <div class="card-body">
