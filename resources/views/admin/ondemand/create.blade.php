                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Add On-Demand Resources Article
                        </li>
                    </ol>
                </nav>
            </div>
...
<div class="container-fluid">
    <form method="POST" action="{{ route('admin.articles.on-demand-resources.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <h5 class="card-header">Adding new on-demand resources article</h5>
                    <div class="card-body">
