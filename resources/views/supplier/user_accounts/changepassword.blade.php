...
@section('content')
    ...
    <div class="container-fluid">
        <form method="POST" action="{{ route('supplier.my.accounts.change_password.update') }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-9">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="password" id="current_password"
                                        ...
                                        name="current_password" maxlength="150" />
                                    <span class="input-group-text"><a href="javascript:;" id="toggle_curr_pwd"><i
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="password" id="new_password"
                                        ...
                                        maxlength="150" />
                                    <span class="input-group-text"><a href="javascript:;" id="toggle_new_pwd"><i
                                                class="fas fa-eye"></i></a></span>
                                    @error('new_password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="password" id="new_password_confirmation"
                                        ...
                                        name="new_password_confirmation" maxlength="150" />
                                    <span class="input-group-text"><a href="javascript:;" id="toggle_con_pwd"><i
                                                class="fas fa-eye"></i></a></span>
                            ...
                            <div class="form-group row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        value="{{ Auth::guard('supplier')->user()->created_at->format('F j, Y, g:i A') }}"
                                        readonly />
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Date Updated</label>
                                    <input type="text" class="form-control form-control-sm"
                                        value="{{ Auth::guard('supplier')->user()->updated_at->format('F j, Y, g:i A') }}"
                                        readonly />
                                </div>
                                <hr class="w-100 mt-2">
