    ...
    <div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of exhibition & conferences</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/exhibitions-conferences/create" class="btn btn-warning btn-sm text-white" role="button">Add new exhibition & conference</a>
                        </div>
                        <div class="table-responsive">
                            <vue-good-table
                                ...
                                <template slot="table-row" slot-scope="props">
                                    <span v-if="props.column.field == 'conference_date'">
                                        {{ props.row.conference_date | moment("MMM DD YYYY") }}
                                    </span>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark">
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/exhibitions-conferences/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/exhibitions-conferences/list', formData)
            .then(response => {
        ...
        doRemove(id) {
            this.$swal({
                ...
                preConfirm: (value) => {
                    if (value) {
                        axios.delete('/admin/exhibitions-conferences/'+id)
                        .then(response => {
                            if (response.status === 200) {
                                Vue.$toast.success('Conference successfully deleted.', {
                                    position: 'top-right',
