    ...
    <div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <label for="title" class="form-label">Certification Name</label>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of certifications</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/certifications/create" class="btn btn-warning btn-sm text-white" role="button">Add new certification</a>
                        </div>
                            ...
                            <vue-good-table
                                ...
                                <template slot="table-row" slot-scope="props">
                                    <span v-if="props.column.field === 'title'">
                                        <span v-tooltip="props.row.title">{{ props.row.title }}</span>
                                    </span>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark">
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/certifications/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/certifications/list', formData)
            .then(response => {
        ...
        doRemove(id) {
            this.$swal({
                ...
                preConfirm: (value) => {
                    if (value) {
                        axios.delete('/admin/certifications/'+id)
                        .then(response => {
                            if (response.status === 200) {
                                Vue.$toast.success('Certification successfully deleted.', {
                                    position: 'top-right',
