    ...
    <div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of sustainable solutions articles</h5>
                        <div class="text-end pb-3">
                            <a href="/admin/articles/sustainable-solutions/create" class="btn btn-warning btn-sm text-white" role="button">Add new article</a>
                        </div>
                            ...
                            <vue-good-table
                                ...
                                <template slot="table-row" slot-scope="props">
                                    ...
                                    <span v-else-if="props.column.field == 'created_at'">
                                        {{ props.row.created_at | moment("MM/DD/YY LT") }}
                                    </span>
                                    <span v-else-if="props.column.field == 'updated_at'">
                                        {{ props.row.updated_at | moment("MM/DD/YY LT") }}
                                    </span>
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" :href="'/admin/articles/sustainable-solutions/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/articles/sustainable-solutions/list', formData)
            .then(response => {
        ...
        doRemove(id) {
            this.$swal({
                ...
                preConfirm: (value) => {
                    if (value) {
                        axios.delete('/admin/articles/sustainable-solutions/'+id)
                        .then(response => {
                            if (response.status === 200) {
