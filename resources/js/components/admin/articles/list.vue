    ...
    <div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of news & articles</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/news-articles/create" class="btn btn-warning btn-sm text-white" role="button">Add new article</a>
                        </div>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                                                <li v-if="permissions.can_view"><a class="dropdown-item" :href="'/admin/news-articles/'+props.row.id" target="_blank"><i class="far fa-eye"></i> Preview</a></li>
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/news-articles/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/news-articles/list', formData)
            .then(response => {
        ...
        doRemove(id) {
            this.$swal({
                ...
                preConfirm: (value) => {
                    if (value) {
                        axios.delete('/admin/news-articles/'+id)
                        .then(response => {
                            if (response.status === 200) {
