    ...
    <div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of all pages</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/pages/create" class="btn btn-warning btn-sm text-white" role="button">Add new page</a>
                        </div>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark">
                                                <li v-if="permissions.can_view"><a class="dropdown-item" :href="'/admin/pages/'+props.row.id" target="_blank"><i class="far fa-eye"></i> Preview</a></li>
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/pages/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/pages/list', formData)
            .then(response => {
            ...
            this.$swal({
                ...
                preConfirm: (value) => {
                    if (value) {
                        ...
                        .then(response => {
                            if (response.status === 200) {
                                Vue.$toast.success('Page successfully deleted.', {
                                    position: 'top-right',
