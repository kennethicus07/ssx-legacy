    ...
    <div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of all widgets</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/widgets/create" class="btn btn-warning btn-sm text-white" role="button">Add new widget</a>
                        </div>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark">
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/widgets/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/widgets/list', formData)
            .then(response => {
        ...
        doRemove(id) {
            this.$swal({
                ...
                preConfirm: (value) => {
                    if (value) {
                        axios.delete('/admin/widgets/'+id)
                        .then(response => {
                            if (response.status === 200) {
                                Vue.$toast.success('Widget successfully deleted.', {
                                    position: 'top-right',
