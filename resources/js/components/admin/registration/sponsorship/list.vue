        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            List of sponsorship registrations
                        </h5>
...
export default {
    data() {
        return {
            columns: [
                ...
                {
                    label: "Sponsorship Response",
                    field: "sponsorship_response_label",
                    tdClass: "align-middle text-left",
                    sortable: false,
                },
    ...
    methods: {
        getLists() {
            ...
            axios
                .post(
                    "/admin/registration/suppliers/sponsorship-list",
                    formData
                )
                .then((response) => {
