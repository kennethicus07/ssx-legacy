    ...
    <div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of featured programs & offers</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/export-enablers/programs-offers/create" class="btn btn-warning btn-sm text-white" role="button">Add new featured program & offfer</a>
                        </div>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                                                <li v-if="permissions.can_view"><a class="dropdown-item" :href="'/admin/export-enablers/programs-offers/'+props.row.id" target="_blank"><i class="far fa-eye"></i> Preview</a></li>
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/export-enablers/programs-offers/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/export-enablers/programs-offers/list', formData)
            .then(response => {
        ...
        doRemove(id) {
            this.$swal({
                title: 'Are you sure you want to delete this program & offer?',
                icon: 'question',
                ...
                preConfirm: (value) => {
                    if (value) {
                        axios.delete('/admin/export-enablers/programs-offers/'+id)
                        .then(response => {
                            if (response.status === 200) {
                                Vue.$toast.success('Program & offer successfully deleted.', {
                                    position: 'top-right',
