    ...
    <div>
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label for="title" class="form-label">Company E-mail Address</label>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of enablers</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/export-enablers/companies/create" class="btn btn-warning btn-sm text-white" role="button">Add new enabler</a>
                        </div>
                        <div class="table-responsive">
                            <vue-good-table
                                ...
                                <template slot="table-row" slot-scope="props">
                                    <span v-if="props.column.field === 'co_name'">
                                        <span v-tooltip="props.row.co_name">{{ props.row.co_name | str_limit(40) }}</span>
                                    </span>
                                    <span v-else-if="props.column.field === 'co_email'">
                                        <span v-tooltip="props.row.co_email">{{ props.row.co_email | str_limit(30) }}</span>
                                    </span>
                                    <span v-else-if="props.column.field === 'is_featured'">
                                        <span v-if="props.row.is_featured === 1" class="badge bg-success">Yes</span>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark">
                                                <li v-if="permissions.can_view"><a class="dropdown-item" :href="'/services/export-enablers'" target="_blank"><i class="far fa-eye"></i> Preview</a></li>
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/export-enablers/companies/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/export-enablers/companies/list', formData)
            .then(response => {
        ...
        doRemove(id) {
            this.$swal({
                title: 'Are you sure you want to delete this enabler?',
                icon: 'question',
                ...
                preConfirm: (value) => {
                    if (value) {
                        axios.delete('/admin/export-enablers/companies/'+id)
                        .then(response => {
                            if (response.status === 200) {
                                Vue.$toast.success('Enabler successfully deleted.', {
                                    position: 'top-right',
