    ...
    <div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List of home page banners</h5>
                        <div class="text-end pb-3" v-if="permissions.can_add">
                            <a href="/admin/carousel-banners/create" class="btn btn-warning btn-sm text-white" role="button">Add new banner</a>
                        </div>
                                    ...
                                    <span v-else-if="props.column.field == 'actions'">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark">
                                                <li v-if="permissions.can_edit"><a class="dropdown-item" :href="'/admin/carousel-banners/'+props.row.id+'/edit'"><i class="far fa-edit"></i> Edit</a></li>
...
export default {
    ...
    methods: {
        getLists() {
            ...
            axios.post('/admin/carousel-banners/list', formData)
            .then(response => {
