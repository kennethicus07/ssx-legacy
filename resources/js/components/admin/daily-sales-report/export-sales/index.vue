                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <input
                                    ...
                                    v-model="
                                        serverParams.columnFilters.supplier_name
                                    "
                                />
                            </div>
...
export default {
    ...
    methods: {
        ...
        getLists() {
            ...
            axios
                .post(
                    "/api/admin/daily-sales-report/export-sales/list",
                    formData
                )
                .then((res) => {
        ...
        editSale(row) {
            window.location.href = `/supplier/daily-sales-report/export-sales/${row.id}/edit`;
        },
        ...
        deleteSale(row) {
            this.$swal({
                ...
                axios
                    .delete(
                        `/supplier/daily-sales-report/export-sales/${row.id}`
                    )
                    .then(() => {
                        this.getLists();
                        ...
                        this.$swal({
                            title: "Deleted!",
                            text: "Export sale has been deleted.",
                            icon: "success",
                            timer: 1500,
                    ...
                    .catch(() => {
                        this.$swal({
                            title: "Error!",
                            text: "Failed to delete export sale.",
                            icon: "error",
                        });
                    });
            });
        ...
        exportExcel() {
            const params = {
                filter: JSON.stringify(this.serverParams.columnFilters),
            };

            axios({
                url: "/admin/daily-sales-report/export-sales/export",
                method: "GET",
                params,
                responseType: "blob",
            })
                .then((response) => {
                    ...
                    link.download = "export-sales.xlsx";
