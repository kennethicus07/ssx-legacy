...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                ...
                { label: "Retail Booked(₱)", field: "booked" },
    ...
    methods: {
        ...
        getLists() {
            ...
            axios
                .post(
                    "/api/admin/daily-sales-report/retail-sales/list",
                    formData
                )
                .then((res) => {
        ...
        editSale(row) {
            window.location.href = `/supplier/daily-sales-report/retail-sales/${row.id}/edit`;
        },
        ...
        deleteSale(row) {
            this.$swal({
                ...
                axios
                    .delete(
                        `/supplier/daily-sales-report/retail-sales/${row.id}`
                    )
                    .then(() => {
                        this.getLists();
        ...
        exportExcel() {
            ...
            axios({
                url: "/admin/daily-sales-report/retail-sales/export",
                method: "GET",
                params,
                responseType: "blob",
            })
