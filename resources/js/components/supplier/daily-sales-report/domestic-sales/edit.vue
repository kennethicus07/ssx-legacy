        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xl-9">
                <div class="card shadow-sm border-0">
                    ...
                    >
                        <div>
                            <h5 class="mb-0">Edit Domestic Sale</h5>
                            <p class="text-muted">
                                Update domestic transaction details
                            </p>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <span class="step-circle-domestic me-2">1</span>
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <span class="step-circle-domestic me-2">2</span>
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <span class="step-circle-domestic me-2">3</span>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label"
                                        >Domestic Under Negotiation</label
                                    >
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <span class="step-circle-domestic me-2">4</span>
                        ...
                        >
                            ...
                            <button
                                ...
                                @click="submitForm"
                            >
                                <span>Update Domestic Sale</span>
                            </button>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        getSale() {
            axios
                .get(
                    `/api/supplier/daily-sales-report/domestic-sales/${this.params.sale_id}`
                )
                .then((res) => {
        ...
        deleteSale() {
            this.$swal({
                ...
                axios
                    .delete(
                        `/supplier/daily-sales-report/domestic-sales/${this.params.sale_id}`
                    )
                    .then(() => {
                        this.$swal({
                            title: "Deleted!",
        ...
        submitForm() {
            ...
            axios
                ...
                .then(() => {
                    this.toast.success("Domestic sale updated successfully");
                })
                .catch(() => {
                    this.toast.error("Failed to update domestic sale");
                })
                .finally(() => {
        ...
        goBack() {
            window.location.href =
                "/supplier/daily-sales-report/domestic-sales";
        },
    },
};
</script>
