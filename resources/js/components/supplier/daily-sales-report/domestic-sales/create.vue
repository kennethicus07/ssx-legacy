        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xl-9">
                <div class="card shadow-sm border-0">
                    ...
                    >
                        <div>
                            <h5 class="mb-0">Create Domestic Sale</h5>
                            <p class="text-muted">
                                Fill in the details to record a new domestic
                                transaction
                            </p>
                        </div>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios
                .post(
                    "/supplier/daily-sales-report/domestic-sales/store",
                    payload
                )
                .then((res) => {
                    this.toast.success("Domestic sale saved successfully!");
                ...
                .catch((error) => {
                    ...
                    this.toast.error("Failed to save domestic sale.");
                })
                .finally(() => {
