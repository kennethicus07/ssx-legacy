        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xl-9">
                <div class="card shadow-sm border-0">
                    ...
                    >
                        <div>
                            <h5 class="mb-0">Edit Export Sale</h5>
                            <p class="text-muted">
                                Update export transaction details
                            </p>
                        </div>
...
export default {
    ...
    methods: {
        getSale() {
            axios
                .get(
                    `/api/supplier/daily-sales-report/export-sales/${this.params.sale_id}`
                )
                .then((res) => {
                    ...
                    this.form = {
                        ...
                        country_destination: sale.country_destination,
        ...
        deleteSale() {
            this.$swal({
                ...
                axios
                    .delete(
                        `/supplier/daily-sales-report/export-sales/${this.params.sale_id}`
                    )
                    .then(() => {
                        this.$swal({
                            title: "Deleted!",
        ...
        submitForm() {
            ...
            axios
                ...
                .then(() => {
                    this.toast.success("Export sale updated successfully");
                })
                .catch(() => {
                    this.toast.error("Failed to update export sale");
                })
                .finally(() => {
