                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea
                            ...
                            :class="{
                                'is-invalid':
                                    validation.env_conservation.$error,
                            }"
                        ></textarea>
                        <div class="form-text fs-12">
                        ...
                        <div v-if="validation.env_conservation.$error">
                            <div
                                class="fw-light invalid-feedback d-block"
                                v-if="!validation.env_conservation.required"
                            >
                                Environmental/ Sustainability Projects &
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            :class="{
                                'is-invalid': validation.website.$error,
                            }"
                        />
