...
class IntelligenceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.intelligence.create', compact('categories','types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.articles.solutions-intelligence.index')->with('status', 'Article successfully saved.');
    }
    ...
    public function list(Request $request)
    {
        ...
        $articles = Article::where('article_type', '=', 'solutions-intelligence');
        ...
        $arr_permissions = [
            'can_view' => Auth::user()->can('view intelligence'),
            'can_edit' => Auth::user()->can('edit intelligence'),
            'can_add' => Auth::user()->can('add intelligence'),
            'can_delete' => Auth::user()->can('delete intelligence')
        ];
    ...
    public function edit($id)
    {
        ...
        return view('admin.intelligence.update', compact('article','categories','types','arr_tags'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.articles.solutions-intelligence.index')->with('status', 'Article successfully updated.');
    }
