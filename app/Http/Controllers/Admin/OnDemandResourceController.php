...
class OnDemandResourceController extends Controller
{
    ...
    {
        return view('admin.ondemand.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.ondemand.create', compact('categories','types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $article->article_type = 'on-demand-resources';
        ...
        return redirect()->route('admin.articles.on-demand-resources.index')->with('status', 'Article successfully saved.');
    }
    ...
    public function list(Request $request)
    {
        ...
        $articles = Article::where('article_type', '=', 'on-demand-resources');
        ...
        $arr_permissions = [
            'can_view' => Auth::user()->can('view ondemand'),
            'can_edit' => Auth::user()->can('edit ondemand'),
            'can_add' => Auth::user()->can('add ondemand'),
            'can_delete' => Auth::user()->can('delete ondemand')
        ];
    ...
    public function edit($id)
    {
        ...
        return view('admin.ondemand.update', compact('article','categories','types','arr_tags'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.articles.on-demand-resources.index')->with('status', 'Article successfully updated.');
    }
