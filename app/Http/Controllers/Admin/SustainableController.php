...
class SustainableController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.sustainable.create', compact('categories','types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $article->article_type = 'sustainable-solutions';
        $article->author = $request->input('author');
        $article->content = $request->input('content');
        $article->status = $request->input('status') ? 1 : 0;
        $article->is_featured = $request->input('featured') ? 1 : 0;
        ...
        return redirect()->route('admin.articles.sustainable-solutions.index')->with('status', 'Article successfully saved.');
    }
    ...
    public function list(Request $request)
    {
        ...
        $articles = Article::where('article_type', '=', 'sustainable-solutions');
        ...
        return response()->json(['total' => $total_articles, 'data' => $records], 200);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.sustainable.update', compact('article','categories','types','arr_tags'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.articles.sustainable-solutions.index')->with('status', 'Article successfully updated.');
    }
