...
private function getLatestFairCode(): ?string
{
    ...
    public function index()
    {
        ...
        return view('supplier.daily_sales_report.domestic_sales.index',compact('supplier_id'));
    }

    public function create(Request $request){
      $supplier_id  = Auth::guard('supplier')->user();
        return view('supplier.daily_sales_report.domestic_sales.create', compact('supplier_id'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'type_of_purchaser_buyer' => 'required|string|max:255',
        ...
        $sale = ExhibitorsSuppliersSale::create([
            ...
            'type_of_purchaser_buyer' => $request->type_of_purchaser_buyer,
            'booked' => $request->booked ?? 0,
            'under_negotiation' => $request->under_negotiation ?? 0,
            'date_of_sale' => $request->date_of_sale,
            'remarks' => $request->remarks,
            'sales_type' => SalesTypeStatus::DOMESTIC,
        ]);

        return response()->json([
            'message' => 'Domestic sale created successfully',
            'data' => $sale
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('supplier.daily_sales_report.domestic_sales.edit',
    ...
    public function update(Request $request, $id)
{
    ...
    return response()->json([
        'message' => 'Domestic sale updated successfully',
        'data' => $sale
    ]);
    }
...
public function destroy($id)
{
    ...
    return response()->json([
        'message' => 'Domestic sale deleted successfully'
    ]);
}
