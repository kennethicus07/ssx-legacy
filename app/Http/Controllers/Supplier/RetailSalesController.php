...
private function getLatestFairCode(): ?string
{
    ...
    public function index()
    {
        ...
        return view('supplier.daily_sales_report.retail_sales.index',compact('supplier_id'));
    }

    public function create(Request $request){
      $supplier_id  = Auth::guard('supplier')->user();
        return view('supplier.daily_sales_report.retail_sales.create', compact('supplier_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $sale = ExhibitorsSuppliersSale::create([
            ...
            'sales_type' => SalesTypeStatus::RETAIL,
        ]);
    ...
    public function edit($id)
    {
        ...
        return view('supplier.daily_sales_report.retail_sales.edit',
    ...
    public function update(Request $request, $id)
{
    ...
    return response()->json([
        'message' => 'Retail sale updated successfully',
        'data' => $sale
    ]);
    }
