...
class ConformeRejectedNotification extends Mailable
{
    ...
    {
        $subject = "Supplier/Exhibitor \"{$this->user->name}\" Declined Conforme for {$this->event->event_name}";

        return $this->subject($subject)
                    ->view('emails.registration.supplier.conforme_rejected')->with([
